    ...
    fluidRow(
      column(
        ...
        div(
          ...
          numericInput(ns("wall_height"), "Wall Height: (mm)", value = 1000, min = 100, max = 3000, width = '100%'),
          numericInput(ns("wall_width"), "Wall Width: (mm)", value = 1000, min = 100, max = 1200, width = '100%'),
          numericInput(ns("wall_offset"), "Tile Offset: (mm)", value = 5, min = 0, max = 500, width = '100%'),
          
          selectInput(
            ns("tile_size"),
            "Tile Size:",
            choices = c("10x20", "25x50", "50x100", "75x150", "100x200", "150x300"),
            selected = "10x20",
            width = '100%'
          ),
          selectInput(
